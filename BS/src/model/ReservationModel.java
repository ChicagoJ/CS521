...
public class ReservationModel implements TableModel {
	...
	public void insertRow(String reservationId, int cruiseNo, String dateOfReservesation, String l)
			throws SQLException {
		...
		try {
			...
			this.reservationRowSet.updateString("dateReservationMade", dateOfReservesation);
			this.reservationRowSet.updateString("datePaid", l);
