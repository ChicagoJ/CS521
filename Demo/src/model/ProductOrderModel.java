...
public class ProductOrderModel implements TableModel{
	...
	public void insertRow(String orderNo, int bookNo, java.sql.Date dateOfOrder, java.sql.Date l ) throws SQLException{
		try {
			this.OrderRowSet.moveToInsertRow();
			this.OrderRowSet.updateString("orderNo", orderNo);
